...
export default function Details({ params: { id } }: { params: { id: string } }) {
    return (
            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap items-center justify-center">
                    <Image
                        ...
                        src="/assets/Nice Watch bro-1690289141131.png"
                        width={200}
                        height={500}
                    />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 className="text-sm title-font text-gray-500 tracking-widest">Watches</h2>
